...
import { IPass } from "./compute/IPass";
import { ComputePassBuilder } from "./compute/ComputePassBuilder";
import { Uniforms } from "./compute/Uniforms";

export class MiltiPassRenderer {
    ...
    async init() {
        ...
        this.computePassBuilder = new ComputePassBuilder(device, this.canvas);
        this.device = device;
